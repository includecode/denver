...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 19 12:49:27 2020
...
y1 = [50, 16, 40, 46, 42, 13, 16, 11, 50, 41, 16]
y2 = [50, 16, 40, 46, 42, 14, 16, 12, 48, 41, 16]
...
print("V(y) = {}".format(covMatrixX1Y[2]))

print("\n\n\t\t/---------------%/%/%/%/%/%/%//%//%/%/----------\n\nCov(x) = ")
print("Cov(a, a) Cov(a, b) Cov(a, c)")
print("Cov(b, a) Cov(b, b) Cov(b, c)")
print("Cov(c, a) Cov(c, b) Cov(c, c)")
print("Cov(d, a) Cov(d, b) Cov(d, c)")
...
print("(  ({})   ({})  ({})".format(covMatrixAa[1], covMatrixAb[1], covMatrixAc[1]))
print("(  ({})   ({})  ({})".format(covMatrixBa[1], covMatrixBb[1], covMatrixBc[1]))
print("(  ({})   ({})  ({})".format(covMatrixCa[1], covMatrixCb[1], covMatrixCc[1]))
...
print("\t\t| |\n")
print("{}    {}    {}".format(MI[0][0], MI[0][1], MI[0][2]))
print("{}    {}    {}".format(MI[1][0], MI[1][1], MI[1][2]))
print("{}    {}    {}".format(MI[2][0], MI[2][1], MI[2][2]))
...
for j in range(len(MI)):
    ...
    prod = (line[0] * covMatrixX1Y[1]) + (line[1] * covMatrixX2Y[1]) + (line[2] * covMatrixX3Y[1])
    print("({} * {}) + ({} * {}) + ({} * {}) = # {} #".format(line[0], covMatrixX1Y[1], line[1], covMatrixX2Y[1], line[2], covMatrixX3Y[1], prod))
    res.append(prod)
...
print("###################################")
print("#Y = Ax + b +ep ==> Y = {} + {}x1 + {}x2 + {}x3+epsilon".format(bChapeau, res[0], res[1], res[2]))
print("#Y = Ax + b +ep ==> Y = {} + {}x1 + {}x2 + {}x3".format(bChapeau, res[0], res[1], res[2]))
...
for i in range(len(a1)):
        obs = (res[0] * a1[i]) + (res[1] * b1[i]) + (res[2] * c1[i]) + bChapeau
        print("({} * {}) + ({} * {}) + ({} * {}) + {} = {}".format(res[0], a1[i], res[1], b1[i], res[2], c1[i], bChapeau, obs))
